        ...
        <div>
            <div className="row m-3 carouselboxes">
                <div className="col-sm-3 col-sm-12 col-md-6 col-xl-4 col-xxl-3 mx-auto">
                    <div className="card p-3 border border-light rounded-0 m-2"  style={{width:"350px"}}>
                        <div className="card-body">
                            <h5 className="card-title">{props.productObj.Text1}</h5>
                        </div>
                ...
                <div className="col-sm-3 col-sm-12 col-md-6 col-xl-4 col-xxl-3 mx-auto">
                    <div className="card p-3 border border-light rounded-0 m-2"  style={{width:"350px"}}>
                        <div className="card-body">
                            <h5 className="card-title">{props.productObj.Text2}</h5>
                        </div>
                ...
                <div className="col-sm-3 col-sm-12 col-md-6 col-xl-4 col-xxl-3 mx-auto">
                    <div className="card p-3 border border-light rounded-0 m-2"  style={{width:"350px"}}>
                        <div className="card-body">
                            <h5 className="card-title">{props.productObj.Text3}</h5>
                        </div>
                ...
                <div className="col-sm-3 col-sm-12 col-md-6 col-xl-4 col-xxl-3 mx-auto">
                    <div className="card p-3 border border-light rounded-0 m-2"  style={{width:"350px"}}>
                        <div className="card-body">
                            <h5 className="card-title">{props.productObj.Text4}</h5>
                        </div>
