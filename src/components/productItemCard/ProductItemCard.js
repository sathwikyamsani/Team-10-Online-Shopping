...
function ProductItemCard(props){
  ...
  const addToCart = (userObj) => {
    ...
    return (
        <div>
            ...
            {/* <div className="col-sm-3 col-xl-3 col-md-6 col-lg-3 col-xs-3" style={{width:"100%"}}>
                <div className="card p-3 border border-light rounded-0 m-2"  >
                    <img src={props.productObj.ProductImage}  style={{height:"100%"}} alt="..." />
                        <div className="card-body">
                            ...
                            <span> 4.5</span>
                            <h6>{props.productObj.ProductText}</h6>
                            <h5>Rs.{props.productObj.ProductCost}/-</h5>
                        <div>
                            <a className='pt-2 text-success fs-6' href="#" data-bs-toggle="modal" data-bs-target="#exampleModalToggle3" >More</a>
                        </div>
                        </div>
                        <div className='d-grid gap-2 d-md-flex justify-content-md-end'>
                            <button className='btn btn-light text-dark border-dark me-md-2' data-bs-toggle='modal' data-bs-target='#exampleModalToggle' >Buy Now</button>
                        </div>
  ...
  <div className="modal-dialog modal-dialog-centered">
    <div className="modal-content">
      <div className="modal-header border-light">
        <h5 className="modal-title" id="exampleModalToggleLabel">Description</h5>
        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div className="modal-body">
        {props.productObj.Description}
      </div>

      <div className='modal-footer border-light'>
                            <button className='btn btn-light text-dark border-dark' data-bs-toggle='modal' data-bs-target='#exampleModalToggle' >Buy Now</button>
                    </div>
    </div>
  </div>
</div>
  ...
  <div className="modal-dialog modal-dialog-centered">
    <div className="modal-content">
      ...
      <div className="modal-footer border-light">
        <button className="btn btn-light text-dark border-dark" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal">Add to cart</button>
      </div>
    </div>
  </div>
</div>
...
<div className="modal fade" id="exampleModalToggle2" aria-hidden="true" aria-labelledby="exampleModalToggleLabel2" tabindex="-1">
  <div className="modal-dialog modal-dialog-centered">
    <div className="modal-content">
      <div className="modal-header border-light">
        <h5 className="modal-title" id="exampleModalToggleLabel2"></h5>
        <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div className="modal-body border-light mx-auto ">
        <h3><i class="bi bi-check border-light bg-primary"></i> Item Added successfully to the cart</h3>
      </div>
      <div className="modal-footer border-light">
        <button className="btn btn-light text-dark border-dark" data-bs-target="#exampleModalToggle" data-bs-toggle="modal">Go to cart</button>
      </div>
    </div>
  </div>
</div>
